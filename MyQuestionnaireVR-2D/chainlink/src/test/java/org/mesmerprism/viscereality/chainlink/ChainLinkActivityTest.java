...
public final class ChainLinkActivityTest {
    ...
    public void startPlanLaunchesFirstQuestionnaireAndWritesState() throws Exception {
        ...
        assertEquals("org.mesmerprism.viscereality.questionnaires2d.RUN", launched.getAction());
        ...
        assertEquals("org.mesmerprism.viscereality.chainlink", launched.getStringExtra("mq.callerPackage"));
    ...
    private static Intent startPlanIntent(String planJson) {
        ...
        intent.setClassName("org.mesmerprism.viscereality.chainlink", "org.mesmerprism.viscereality.chainlink.ChainLinkActivity");
