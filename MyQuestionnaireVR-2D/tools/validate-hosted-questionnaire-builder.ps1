...
$requirements = @(
    ...
    [ordered]@{ id = 'trigger-block-assignment'; text = 'Build questionnaire blocks' },
    [ordered]@{ id = 'questionnaire-type-select'; text = 'Questionnaire block' },
    ...
    [ordered]@{ id = 'generate-apk-button'; text = 'Generate APK' },
    [ordered]@{ id = 'install-apk-button'; text = 'Install APK on Quest' },
    [ordered]@{ id = 'generate-apk-button-gated'; text = 'id="generateApkAppButton" class="primary" type="button" data-requires-apk-control' },
    [ordered]@{ id = 'install-apk-button-gated'; text = 'id="installApkAppButton" type="button" data-requires-apk-control' },
