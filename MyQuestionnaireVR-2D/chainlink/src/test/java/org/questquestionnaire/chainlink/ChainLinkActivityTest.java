...
public final class ChainLinkActivityTest {
    ...
    public void startPlanLaunchesFirstQuestionnaireAndWritesState() throws Exception {
        ...
        assertEquals("org.questquestionnaire.questionnaires2d.RUN", launched.getAction());
        ...
        assertEquals("org.questquestionnaire.chainlink", launched.getStringExtra("mq.callerPackage"));
    ...
    public void triggerCommandRoutesMappedBlockAndWaitsAfterCompletion() throws Exception {
        ...
        trigger.setClassName("org.questquestionnaire.chainlink", "org.questquestionnaire.chainlink.ChainLinkActivity");
        ...
        assertEquals(
            new ComponentName(
                ...
                "org.questquestionnaire.temporaltracer2d.MainActivity"),
            launched.getComponent());
        assertEquals("org.questquestionnaire.temporaltracer2d.RUN", launched.getAction());
    ...
    private static Intent startPlanIntent(String planJson) {
        ...
        intent.setClassName("org.questquestionnaire.chainlink", "org.questquestionnaire.chainlink.ChainLinkActivity");
    ...
    private static String triggerPlanJson() {
        return "{"
            ...
            + "\"activity\":\"org.questquestionnaire.temporaltracer2d.MainActivity\","
            + "\"action\":\"org.questquestionnaire.temporaltracer2d.RUN\","
