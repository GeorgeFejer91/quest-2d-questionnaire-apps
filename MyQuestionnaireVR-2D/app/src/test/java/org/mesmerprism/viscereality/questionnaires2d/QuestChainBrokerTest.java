...
public final class QuestChainBrokerTest {
    ...
    public void startPlanLaunchesFirstScenarioAndPersistsState() throws Exception {
        ...
        assertEquals("org.mesmerprism.viscereality.CHAIN_COMMAND", result.outgoingIntent.getAction());
        ...
        assertEquals("org.mesmerprism.viscereality.questionnaires2d.QuestChainBrokerActivity", result.outgoingIntent.getStringExtra(QuestChainBroker.EXTRA_BROKER_ACTIVITY));
    ...
    public void continuePlanLaunchesQuestionnaireWithBrokerAsCaller() throws Exception {
        ...
        assertEquals(new ComponentName(
            ...
            "org.mesmerprism.viscereality.questionnaires2d.MainActivity"), result.outgoingIntent.getComponent());
        ...
        assertEquals("org.mesmerprism.viscereality.questionnaires2d", result.outgoingIntent.getStringExtra(QuestionnaireLaunchContext.EXTRA_CALLER_PACKAGE));
        assertEquals("org.mesmerprism.viscereality.questionnaires2d.QuestChainBrokerActivity", result.outgoingIntent.getStringExtra(QuestionnaireLaunchContext.EXTRA_CALLER_ACTIVITY));
    ...
    private static String twoStepScenarioQuestionnairePlan() {
        return "{"
            ...
            + "\"action\":\"org.mesmerprism.viscereality.CHAIN_COMMAND\",\"command\":\"startScenario\"},"
            + "{\"id\":\"questionnaire-a\",\"type\":\"questionnaire\",\"package\":\"org.mesmerprism.viscereality.questionnaires2d\",\"activity\":\".MainActivity\","
