...
public final class ChainHookActivity extends Activity {
    public static final String ACTION_CHAIN_COMMAND = "org.mesmerprism.viscereality.CHAIN_COMMAND";
    public static final String ACTION_BROKER = "org.mesmerprism.viscereality.questionnaires2d.BROKER";
    public static final String QUESTIONNAIRE_PACKAGE = "org.mesmerprism.viscereality.questionnaires2d";
    public static final String BROKER_ACTIVITY = "org.mesmerprism.viscereality.questionnaires2d.QuestChainBrokerActivity";
    public static final String TAG = "ViscerealityChainHook";
